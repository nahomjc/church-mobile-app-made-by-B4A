...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new anywheresoftware.b4a.ShellBA(this, null, null, "fullpentecostalchurch.home.blog", "fullpentecostalchurch.home.blog.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "fullpentecostalchurch.home.blog.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
