...
public class note extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "fullpentecostalchurch.home.blog", "fullpentecostalchurch.home.blog.note");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "fullpentecostalchurch.home.blog", "fullpentecostalchurch.home.blog.note");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "fullpentecostalchurch.home.blog.note", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (note) Create, isFirst = " + isFirst + " **");
...
RDebugUtils.currentLine=9502722;
 //BA.debugLineNum = 9502722;BA.debugLine="Activity.LoadLayout(\"note\")";
mostCurrent._activity.LoadLayout("note",mostCurrent.activityBA);
RDebugUtils.currentLine=9502723;
 //BA.debugLineNum = 9502723;BA.debugLine="WebView1.LoadUrl(\"https://www.calmlywriter.com/on";
mostCurrent._webview1.LoadUrl("https://www.calmlywriter.com/online/");
...
RDebugUtils.currentLine=9699328;
 //BA.debugLineNum = 9699328;BA.debugLine="Sub Button1_Click";
RDebugUtils.currentLine=9699329;
 //BA.debugLineNum = 9699329;BA.debugLine="StartActivity(main1)";
