...
public class arcmenu2 {
    public static RemoteObject myClass;
	public arcmenu2() {
	}
    public static PCBA staticBA = new PCBA(null, arcmenu2.class);
