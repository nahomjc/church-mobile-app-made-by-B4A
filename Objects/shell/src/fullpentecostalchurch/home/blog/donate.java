...
public class donate implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("donate"), "fullpentecostalchurch.home.blog.donate");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, donate.class);
...
public static RemoteObject _target = RemoteObject.createImmutable("");
