...
public class prayer implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("prayer"), "fullpentecostalchurch.home.blog.prayer");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, prayer.class);
...
public static fullpentecostalchurch.home.blog.starter _starter = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",prayer.mostCurrent._activity,"Button1",prayer.mostCurrent._button1,"Button2",prayer.mostCurrent._button2,"Button3",prayer.mostCurrent._button3,"Button4",prayer.mostCurrent._button4,"chat",Debug.moduleToString(fullpentecostalchurch.home.blog.chat.class),"currency",Debug.moduleToString(fullpentecostalchurch.home.blog.currency.class),"donate",Debug.moduleToString(fullpentecostalchurch.home.blog.donate.class),"email",Debug.moduleToString(fullpentecostalchurch.home.blog.email.class),"facebook",Debug.moduleToString(fullpentecostalchurch.home.blog.facebook.class),"Main",Debug.moduleToString(fullpentecostalchurch.home.blog.main.class),"main1",Debug.moduleToString(fullpentecostalchurch.home.blog.main1.class),"map",Debug.moduleToString(fullpentecostalchurch.home.blog.map.class),"mission",Debug.moduleToString(fullpentecostalchurch.home.blog.mission.class),"news",Debug.moduleToString(fullpentecostalchurch.home.blog.news.class),"note",Debug.moduleToString(fullpentecostalchurch.home.blog.note.class),"Starter",Debug.moduleToString(fullpentecostalchurch.home.blog.starter.class),"Urlrefersh",prayer.mostCurrent._urlrefersh,"WebView1",prayer.mostCurrent._webview1,"youtube",Debug.moduleToString(fullpentecostalchurch.home.blog.youtube.class)};
}
}