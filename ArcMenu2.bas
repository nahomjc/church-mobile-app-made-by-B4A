...
#Region Declarations	
	...
	'Default Options
	Private StaticMenuButtonWidth As Int = 0dip
	Private StaticMenuButtonHeight As Int = 0dip
	Private AnimatedMenuButtonWidth As Int = 125dip
	Private AnimatedMenuButtonHeight As Int = 125dip
	Private MenuItemWidth As Int = 50dip
	Private MenuItemHeight As Int = 50dip
...
Private Sub menuButton_Click
	If Not(IsAnimating) Then
		...
		If menuOpen Then
			If animatedMenuButton.IsInitialized Then Animator.InitializeRotateCenter("menuButtonRotate", 90, 0, animatedMenuButton)
			For i = MenuItems.Size - 1 To 0 Step -1
				AnimSet = GetMenuItemAnimation(MenuItems.Get(i), Not(menuOpen))
				AnimSet.Start(MenuItems.Get(i))
			Next
		Else
			If animatedMenuButton.IsInitialized Then Animator.InitializeRotateCenter("menuButtonUnRotate", 0, 90, animatedMenuButton)
